...
Post-roadmap visual/UI pass note: `post-roadmap-visual-ui-pass-1` is a non-numbered follow-up after the completed 17-stage roadmap. The current review tag is `review-visual-ui-pass-1-v3`; v1 and v2 remain immutable as `changes_requested` records. It is limited to original code-generated visual assets, scene backgrounds, shared UI theme/helpers, readability and visual feedback. It does not change game rules, project completion, totalStages, or implement Stage 18.
