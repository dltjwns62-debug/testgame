...
8단계는 `main`에 반영되어 완료됐다. 9단계에서는 유닛 정의에 연결된 Skill Mercenary의 Whirlwind·First Aid와 단일 선택 전용 Q/W 스킬 UI를 검수 대기 중이다. 스킬은 수동 입력으로만 사용하며 Auto Hunt가 자동으로 사용하지 않는다.
