...
Stage 14 scope note: the submitted work is limited to ItemDefinition and ItemInstance data, session inventory, monster drops, equipment slots, weapon compatibility, COMMON/UNIQUE restrictions, equipment stat modifiers, defense-based physical damage, InventoryScene, and existing UI/result integration. It does not implement stage 15 storage, offline progress, browser-refresh persistence, sales, repeat purchases, consumables, or online features.
