...
8단계 v1의 Auto Hunt ON/OFF와 수동 명령 우선순위를 유지하면서, 실제 피해 직후 140px 내 대기 아군의 지역 동료 지원을 추가했다. 주인공·용병·Slime의 근접 추가 사거리를 10px·8px 기준으로 축소하고, 단일 선택 시 공격 범위 원과 `Melee reach` 정보를 표시한다. 기존 10대10 RTS, Gold, 몬스터 제거·3초 재생성 연결은 유지한다.
